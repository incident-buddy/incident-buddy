...
export default function({ loaderData }: Route.ComponentProps) {
	...
	return (
		<div className="flex flex-row items-stretch h-svh">
			...
			<div className="flex flex-col gap-y-2 min-w-xs w-1/4 border-r py-4">
				{/* header */}
				<div className="px-3">
					<h1 className="font-semibold text-lg">Incidents</h1>
					<div className="py-3"><Filter /></div></div>
...
function Card({ title, summary, status, isActive }: { title: string, summary: string; status: { type: StatusType, color: ColorType }; isActive: boolean; }) {
