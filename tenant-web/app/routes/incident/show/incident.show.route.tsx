		...
		<>
			<div className="flex flex-col gap-y-6">
				...
				<div className="flex flex-col gap-y-1">
					<time className="">{incident.declaredAt}</time>
					<div className="flex flex-row items-center">
						<h1 className="flex flex-row gap-x-1 text-xl text-bold items-center">
							<span>${incident.code} {incident.title}</span>
				...
				<div className="flex flex-col gap-y-1">
					...
					<div className="text-sm flex flex-row items-center gap-x-3">
						<Assign role={{label: "インシデントコマンダー", abbr: "IC", color: "red"
						}} onClick={function(): void {
							throw new Error("Function not implemented.");
						}} />
						<Assign role={{ label: "影響範囲調査", abbr: "影響", color: "blue" }} onClick={function(): void {
							throw new Error("Function not implemented.");
						}} />
						<Assign role={{ label: "原因調査", abbr: "原因", color: "green" }} onClick={function(): void {
							throw new Error("Function not implemented.");
						}} />
					</div>
				</div>
