...
const ResumePointEntrySchema = z
  .object({
...
export const TaskExecutionConfigObjectSchema = z
  .object({
...
export const TaskExecutionConfigSchema = buildTaskSchema(
