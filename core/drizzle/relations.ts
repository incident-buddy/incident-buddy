...
export const resourceMastersRelations = relations(resourceMasters, ({one, many}) => ({
	tenant: one(tenants, {
	...
	resourceMasterAttributes_resourceReference: many(resourceMasterAttributes, {
		relationName: "resourceMasterAttributes_resourceReference_resourceMasters_id"
	}),
	resourceMasterAttributes_resourceMasterId: many(resourceMasterAttributes, {
		relationName: "resourceMasterAttributes_resourceMasterId_resourceMasters_id"
	}),
	resources: many(resources),
}));

export const resourceMasterCategoriesRelations = relations(resourceMasterCategories, ({one}) => ({
...
export const resourceMasterAttributesRelations = relations(resourceMasterAttributes, ({one, many}) => ({
...
export const resourceAttributeValuesRelations = relations(resourceAttributeValues, ({one}) => ({
...
export const incidentStatusesRelations = relations(incidentStatuses, ({one, many}) => ({
	tenant: one(tenants, {
...
export const incidentRolesRelations = relations(incidentRoles, ({one, many}) => ({
	tenant: one(tenants, {
...
export const incidentEventHistoriesRelations = relations(incidentEventHistories, ({one}) => ({
	incident: one(incidents, {
